...
import com.hl.banner.R;
import com.hl.banner.adapter.BaseBannerAdapter;
import com.hl.banner.config.BannerConfig;
import com.hl.banner.config.IndicatorConfig;
import com.hl.banner.indicator.Indicator;
import com.hl.banner.transform.MZScaleInTransformer;
import com.hl.banner.transform.ScaleInTransformer;
...
import com.hl.banner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BaseBannerAdapter> extends FrameLayout {
